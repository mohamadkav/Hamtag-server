...
CREATE TABLE AD_CONTENTS(ID SERIAL NOT NULL, CONTENT BYTEA,ADID INT REFERENCES ADS(ID)NOT NULL,CONTENT_TYPE TEXT);
CREATE INDEX AD_CONTENT_AD_INDEX ON AD_CONTENTS(ADID);
ALTER TABLE ADS ADD THUMBNAILID INT REFERENCES AD_CONTENTS(ID);
