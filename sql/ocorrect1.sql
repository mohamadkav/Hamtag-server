...
CREATE TABLE MONEY_WITHDRAWAL (ID SERIAL NOT NULL, DEVICEID INT REFERENCES DEVICES(ID)NOT NULL,STATUS TEXT,USER_COMMENTS TEXT, HAMTAG_COMMENTS TEXT,PRIMARY KEY(ID));
