...
public class NewsShownRequest extends BaseDeviceRequest {
	private enum Error {
		DEVICE_ALREADY_HAS_SHOWN, NEWS_NOT_FOUND, DATE_INVALID, SHOWN_SECONDS_INVALID
	}
	...
	public Response handle() {
		...
		NewsShown newsShown = NewsShownMgr.getNewsShownByDeviceAndAd(DeviceMgr.getDeviceByPhoneNumber(getPhoneNumber()),
				news);
		try {
