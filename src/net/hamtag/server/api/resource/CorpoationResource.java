...
import net.hamtag.server.api.request.types.corporations.panel.AddNewCorporationRequest;
...
public class CorpoationResource {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addNewCorporation(@QueryParam("name")String corpName){
		return new AddNewCorporationRequest(corpName).handle();
	}
}
